                ...
                <tr>
					...
					<td>
                        ...
                        <div class="inTblBoxGroup twinSort wearingGoodsMod">
                            ...
                            <!-- :: open : ksg_3 : [진맛] 검색 결과로 표시되는 내부 테이블 형식의 품목 목록 파트. 여기서는 진짜 테이블을 사용할 것이므로 이것은 display : none 처리.- -->
                            <div class="mockingTbl subStgSetSort" style="display : none;">
                            ...
                            <!-- :: close : ksg_3 : [진맛] 검색 결과로 표시되는 내부 테이블 형식의 품목 목록 파트. 여기서는 진짜 테이블을 사용할 것이므로 이것은 display : none 처리.- -->
