...
<div class="container">
	...
	<?php include $_SERVER['DOCUMENT_ROOT'] . '/additional/pages/additional_left.php'; ?> 
	...
	<div class="wrapper">
		<div class="contents">  
			...
			<div class="section horizontalManageSort notWidth searcManageSort AsymDoub1">    
				<div class="titleBox manageHeadlineSort">정책개선 요청 목록</div>  
				...
				<div class="conGroup verticalManageSort bottomRowSort">
									...
									<td>
										<div class="inTableCheckGroup">
                                            ...
                                            <div class="checkBoxCase">
							    				...
							    				<div class="checkBoxTitle">답변대기</div>
							    			</div>
							    			<div class="checkBoxCase"> 
							    				<div class="checkBoxIconBox">
							    					<input type="checkbox" name="" value="">
							    				...
							    				<div class="checkBoxTitle">답변완료</div>
                                            </div>
							    		</div>
									</td>	
								</tr>
					...
					<table class="searchResultTable ">
						...
						<tr class="reged"> 
							<td>1</td>
							<td>김별</td> 
							<td>회사내 00규칙에 관해 건의..</td>
							<td>2021-01-28</td>
							<td>155</td>
							<td>답변대기</td>
							<td>
								<div class="btnGroup inListTable">
									<a href="javascript:void(0);" class="btn modifySort">보기</a>
					...
					<div class="conGroup verticalManageSort">
						<div class="headLineBox listControlSort">
							<div class="titleBox inlistConSort">
								<div class="titleText">요청사항 상세</div>  
							</div>
						</div>
						...
						<tr>
							<th>작성자</th>
							<td>
								<input class="tbox regFullSort listMod" readonly value="김별"> 
							</td>
							<th>등록일</th>
							<td>
								<input class="tbox regFullSort listMod" readonly value="2020-01-28">
							</td>
						</tr>
						<tr>
							<th>제목</th>
							<td colspan="3">
								<input class="tbox regFullSort listMod" readonly>
							</td>
						</tr>  
						<tr>  
							<th>내용</th>
						...
						<div class="headLineBox listControlSort">
							<div class="titleBox inlistConSort">
								<div class="titleText">요청사항 답변</div>  
							</div> 
						</div>
						<table class="infoGroup">
						<colgroup>
