				...
				<div class="conGroup verticalManageSort bottomRowSort">
					...
					<table class="searchResultTable">
						...
						<tr>
                            ...
                            <td>
                                <input class="tbox regFullSort listMod" placeholder="방식" value="">
                            </td>
                            <td>
                                <input class="tbox regFullSort listMod" placeholder="업체규모" value="">
							</td>
							<td>
                                <input class="tbox regFullSort listMod" placeholder="작업지시 횟수" value="">
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="tbox regFullSort listMod" placeholder="방식" value="2. 업체">
                            </td>
                            <td>
                                <input class="tbox regFullSort listMod" placeholder="업체규모" value="42">
							</td>
							<td>
                                <input class="tbox regFullSort listMod" placeholder="작업지시 횟수" value="1310">
                            </td>
                            <td>
